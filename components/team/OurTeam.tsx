    ...
    return (
        <div className="my-20 gap-x-2 md:flex items-center">
            ...
            url(./images/image-14.jpg)`,
                ...
                >
                    <h1 className="text-[#bab9bd]  text-2xl font-bold md:text-3xl">
                        Meet Coach AB
                    </h1>
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-[#bab9bd] text-lg font-semibold">
                            facilitator
                        </p>
                    </div>
                </div>
            ...
            <div className="w-[95%] mx-auto text-[16px] leading-7 shadow-xl p-4 md:text-[18px] md:w-[600px]">
                <p>
                    ...
                    <button
                        ...
                        className={
                            isClicked
                                ? "block button-eff bg-[#091268] mt-2 py-[4px] px-4 text-white font-semibold rounded hover:border-[1px] hover:text-[whitesmoke] hover:bg-[#ff7300]"
                                : "hidden"
                        }
                    >
                        Read More
                ...
                <p className={isClicked ? "hidden" : "block"}>
                    ...
                    gain practical insights and skills. His approach is designed
                    to empower participants with the knowledge and confidence to
                    navigate CAC regulations and ensure compliance.
                    <button
                        onClick={handleIsClicked}
                        className={
                            isClicked
