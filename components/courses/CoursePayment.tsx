...
function CoursePayment() {
    return (
        <div className="w-full  max-w-[700px] mx-auto p-10 text-center ">
            ...
            <div className="text-[18px] text-center flex flex-col gap-3 mt-6">
                <h2 className="font-bold uppercase text-[#5e5d5d]">
                    Account Details
                </h2>
                <div className="flex gap-x-6 flex-col justify-center text-center  md:flex-row">
                    <p className="font-semibold">Account Name:</p>
                    <p className="uppercase">Akor-Ikpam Abraham</p>
                </div>
                <div className="flex gap-x-6 flex-col justify-center md:flex-row">
